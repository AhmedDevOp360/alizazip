         ...
         <!--<div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="input-group" style="width: 100%">
                        <select class="form-control select2" null id="expense_category_id" name="expense_category_id"><option selected="selected" value="">Seleccione</option><option value="1600">Excento</option></select>
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-block btn-primary btn-modal" data-href="https://sistema.zisco.cloud/expense-categories/create?quick_add=1" data-container=".view_modal"><i class="fa fa-plus"></i> Añadir</button>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="expense_category_id">IMPO CONSUMO:</label>
                    <div class="input-group" style="width: 100%">
                        <select class="form-control select2" null id="expense_category_id" name="expense_category_id"><option selected="selected" value="">Seleccione</option><option value="1600">8%</option></select>
