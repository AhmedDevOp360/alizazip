   ...
   <div class="col-sm-3">
      ...
      <div class="col-md-3">
		<div class="form-group">
			...
			<div class="form-group">
				<select class="form-control select2" style="width: 100%;"  name="payroll_type_contract"><option selected="selected" value="">Seleccione</option><option value="7">A Termino Fijo</option><option value="6">Termino Indefinido</option><option value="5">Obra o Labor</option><option value="4">Aprendizaje</option><option value="2">Practicas o Pasantias</option></select>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<div class="form-group">
				<select class="form-control select2" style="width: 100%;"  name="payroll_type_salary"><option selected="selected" value="">Seleccione</option><option value="7"></option><option value="6">Salario Fijo</option><option value="5">Salario Variable</option></option></select>
			</div>
		</div>
	</div>
      ...
      <div class="col-md-2 hide service_staff_pin_div">
        <div class="form-group">
          {!! Form::label('service_staff_pin', __( 'lang_v1.staff_pin' ) . ':') !!}
            {!! Form::password('service_staff_pin', ['class' => 'form-control', '' => true, 'placeholder' => __( 'lang_v1.staff_pin' ) ]); !!}
        </div>
      </div>
