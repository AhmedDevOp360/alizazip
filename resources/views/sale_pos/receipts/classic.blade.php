    ...
    <body>
        <div class="ticket">
			...
			@endif
	            ...
	            <p>
    				@if(isset($receipt_details->delivery_person_label) && isset($receipt_details->delivery_person))
    					<div class="bw">
    					<b>{!! $receipt_details->delivery_person_label !!}:</b> {!! $receipt_details->delivery_person !!}
    					</div>
    				@endif
    	        </p>
	        </div>
