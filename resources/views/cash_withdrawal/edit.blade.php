...
<section class="content">
    <div class="box box-solid">
        <div class="box-body">
            {!! Form::model($withdrawal, ['url' => action([\App\Http\Controllers\CashWithdrawalController::class, 'update'], [$withdrawal->id]), 'method' => 'put']) !!}
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('amount', $withdrawal->amount, ['class' => 'form-control input_number', 'required']) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
